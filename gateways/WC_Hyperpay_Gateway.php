...
<?php
    ...
    class WC_Hyperpay_STCPay_Gateway extends WC_Hyperpay_Gateway
    {
       function __construct(){
            $this->id = 'hyperpaySR';
            $this->has_fields = false;
            $this->method_title = 'Hyperpay Gateway stc';
            $this->method_description = 'Hyperpay Plugin for Woococcmmerce';
